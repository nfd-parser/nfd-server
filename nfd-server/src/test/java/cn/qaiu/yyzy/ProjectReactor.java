...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.qaiu.yyzy";
    private static final String ARTIFACT_ID = "nfd";
    private static final String PACKAGE_NAME = "cn.qaiu.yyzy";
    private static final String TITLE = "NFD管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.qaiu.yyzy";
        String artifactIdNew = "nfd";
        String packageNameNew = "cn.qaiu.yyzy";
        String titleNew = "NFD管理系统";
